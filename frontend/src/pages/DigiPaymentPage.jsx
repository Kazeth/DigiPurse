                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-1">
                                    <p
                                        className="text-xs text-purple-200/70 font-mono"
                                ...
                                <Tabs defaultValue="send" className="w-full">
                                    <TabsList className="grid w-full grid-cols-3 bg-purple-900/30 border-none">
                                        ...
                                        <TabsTrigger
                                            ...
                                            style={{ fontFamily: 'AeonikBold, sans-serif' }}
                                        >
                                            <Repeat className="mr-2 h-4 w-4"/>Top Up Cycles
                                        </TabsTrigger>
                                    </TabsList>
                                    <TabsContent value="send" className="p-6 space-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2 mt-1">
                                                ...
                                                >
                                                    <SelectTrigger
                                                        className="w-[150px] bg-black/20 border-purple-400/30"
                                                        style={{ fontFamily: 'AeonikLight, sans-serif' }}
                                                    >
                                                        <SelectValue />
                                                    </SelectTrigger>
                                    ...
                                    <TabsContent value="receive" className="p-6 text-center">
                                        ...
                                        <p
                                            className="text-purple-200/70 mt-4 text-xs font-mono break-all"
                                            style={{ fontFamily: 'AeonikLight, sans-serif' }}
                                        >
                    ...
                    <div className="space-y-8">
                        ...
                        <motion.div custom={2.5} initial="hidden" animate="visible" variants={sectionVariants}>
                            <Card className="bg-white/5 border-purple-400/20">
                                <CardHeader><CardTitle
                                    style={{ fontFamily: 'AeonikBold, sans-serif' }}
                                >Recent Transactions</CardTitle></CardHeader>
                                <CardContent>
                                    <ul className="space-y-4">
                                        {transactions.map((tx, i) => (
                                            <li key={i} className="flex items-center justify-between gap-4">
                                                ...
                                                <div className="text-right">
                                                    <p
                                                        className={`font-bold font-mono ${tx.amount.startsWith('+') ? 'text-green-400' : 'text-red-400'}`}
                                                        style={{ fontFamily: 'AeonikBold, sans-serif' }}
                                                    >
                                                        {tx.amount}
                                                    </p>
